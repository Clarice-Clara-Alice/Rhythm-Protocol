window.DarkHorseGameScene = class DarkHorseGameScene extends Phaser.Scene {

constructor() {
   super({
       key: 'DarkHorseGameScene'
   });
}
...
create() {
        ...
        if (!this.mapData) {
            ...
            console.error(
                'ERRO: Não foi possível carregar darkHorseMap.'
            );
